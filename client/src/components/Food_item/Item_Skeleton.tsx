...
const Item_Skeleton = () => {
  return (
    <div className="animate-pulse bg-white border border-gray-100 transition transform duration-700 hover:shadow-xl hover:scale-105 p-4 rounded-lg relative">
      <span className="bg-gray-100 border border-gray-500 rounded-full px-4 py-1 inline-block"></span>
      ...
      <div className="flex flex-col items-center my-3 space-y-2">
        ...
        <button className="bg-gray-400 text-black px-8 py-3 focus:outline-none poppins rounded-full mt-24 transform transition duration-300 hover:scale-105"></button>
      </div>
    </div>
  );
};

export default Item_Skeleton;
