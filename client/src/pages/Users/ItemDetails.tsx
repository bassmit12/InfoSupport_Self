      ...
      <div className="flex items-center justify-center space-x-6">
        <div className="flex-col flex-1">
          ...
          <p className="text-xl font-light">
            Savor the essence of Dutch culinary artistry with our Borrelplank. A
            tantalizing array of creamy Gouda, aged Edam, and bold Maasdam
            ...
            experience with a chilled glass of Dutch beer or local wine. G ather
            your friends and dive into a world of indulgence.
            <br />
            <br />
